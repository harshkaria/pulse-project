...
auth.settings.extra_fields['auth_user']= [
  ...
  Field('weight', label='Weight (lbs)'),
  Field('onboarded', readable=False, writable=False),
  Field('target_groups', type='list:string', label = 'Target Body Groups:', 
    requires = IS_IN_SET(['Shoulders', 'Chest', 'Biceps', 'Triceps', 'Back', 'Legs'], multiple=True))
  ]
